...
import { Rocket, Satellite, Radio, Globe, Activity, Zap, AlertTriangle, Crosshair, RefreshCw, Upload, MapPin, Camera, Eye, Scan, Target, CheckCircle, Video } from 'lucide-react';
import MetricCard from '../components/MetricCard';
import { useLanguage } from '../contexts/LanguageContext';
import { analyzeSatelliteTarget, analyzeSatelliteRecon } from '../services/localAiService';
...
const SpaceCommandView: React.FC = () => {
                ...
                {activeTab === 'overview' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-black rounded-xl border border-gray-800 relative overflow-hidden flex flex-col items-center justify-center group shadow-2xl perspective-[1000px] min-h-[400px]">
                            ...
                            {/* 3D Globe Container */}
                            <div className="relative w-72 h-72 transition-transform duration-75 ease-linear" style={{ transformStyle: 'preserve-3d', transform: `rotateX(15deg) rotateY(${rotation}deg)` }}>
