...
import { Megaphone, MessageSquare, ThumbsUp, ThumbsDown, Globe, Edit3, Send, AlertTriangle } from 'lucide-react';
import MetricCard from '../components/MetricCard';
import { ResponsiveContainer, LineChart, Line, XAxis, YAxis, Tooltip, CartesianGrid } from 'recharts';
import { generatePressRelease } from '../services/localAiService';
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 flex flex-col h-[calc(100vh-140px)]">
            <div className="flex justify-between items-center mb-2 flex-shrink-0">
                <div>
                    <h2 className="text-2xl font-bold text-white tracking-tight">{t('info_title')}</h2>
                    <p className="text-gray-400 text-sm">{t('info_subtitle')}</p>
                </div>
                        ...
                        {!draft ? (
                            <>
                                ...
                                <button 
                                    ...
                                    className="w-full bg-military-accent hover:bg-sky-500 text-white font-bold py-3 rounded mt-4 transition-all disabled:opacity-50 flex justify-center items-center"
                                >
