...
import { generateScenarioBriefing, runStrategySimulation, generateSpeech, generateAAR, expandSimulationDetail } from '../services/localAiService';
      ...
      <div className="w-full">
          {activeTab === 'live' && (
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                  ...
                  <div className="lg:col-span-3 bg-black rounded-lg border border-military-700 overflow-hidden relative h-[500px]">
          ...
          {activeTab === 'readiness' && (
              <div className="h-full grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {/* Readiness Chart */}
                  <div className="bg-military-800 rounded-lg p-6 border border-military-700 min-h-[350px]">
                  ...
                  {/* Supply Status */}
                  <div className="bg-military-800 rounded-lg p-6 border border-military-700 min-h-[300px]">
                                ...
                                <div className={`border-l-4 ${simMode === 'standard' ? 'border-blue-500' : 'border-red-500'} pl-6 py-4 bg-military-900/30 rounded-r-lg`}>
                                    <div className="flex flex-col md:flex-row justify-between items-start">
                                        ...
                                        {isSpeaking ? (
                                            ...
                                            <button onClick={() => playBriefing(typeof currentResult.summary === 'string' ? currentResult.summary : "")} className="text-green-400 hover:text-white flex items-center text-xs mt-2 md:mt-0"><Volume2 size={16} className="mr-1"/> PLAY BRIEFING</button>
                                        )}
                                    </div>
