...
import { generateExamQuestion, evaluateApplicant, draftSRSCommunication, generateCourseRecommendations, analyzeStudentRisk, generateInterventionPlan, generateCurriculumGapAnalysis } from '../services/localAiService';
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-2">
                ...
                <div className="bg-military-800 p-1 rounded-lg border border-military-700 flex flex-wrap gap-1 mt-4 md:mt-0 shadow-lg">
            ...
            <div className="w-full">
                ...
                {activeTab === 'lms_exam' && (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-military-800 rounded-lg p-8 border border-military-700 flex flex-col justify-center relative overflow-hidden min-h-[400px]">
                            ...
                            {examData && (
                                <div className="animate-in fade-in slide-in-from-right-4 relative z-0">
                                    <div className="mb-8">
                ...
                {activeTab === 'lms_course' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-military-800 rounded-lg p-6 border border-military-700 relative min-h-[400px]">
                            {courseLoading && (
                ...
                {activeTab === 'srs_system' && (
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center bg-military-800 p-4 rounded-lg border border-military-700 shadow-lg">
                        ...
                        <div>
                                                ...
                                                <div className="bg-military-900 p-4 rounded border border-military-600">
                                                    {admissionMode === 'text' ? (
                                                        <div className="grid grid-cols-2 gap-4">
                                                            ...
                                                            <button className="bg-blue-600 text-white rounded p-2 text-sm font-bold">Register Student</button>
                                                        </div>
                                                    ) : (
                            ...
                            {srsRole === 'teacher' && (
                                <div className="space-y-6">
                                    <div className="bg-military-800 p-4 rounded-lg border border-military-700 flex justify-between items-center">
                            ...
                            {srsRole === 'student' && (
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    <div className="lg:col-span-1 bg-military-800 p-6 rounded-lg border border-military-700 text-center">
