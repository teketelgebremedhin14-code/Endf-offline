...
import { getStrategicForecast } from '../services/localAiService';
...
const DashboardOverview: React.FC<DashboardOverviewProps> = ({ onNavigate, defcon }) => {
  ...
  if (sitRoomMode) {
      return (
          <div className="min-h-[calc(100vh-140px)] flex flex-col space-y-4 animate-in fade-in zoom-in duration-300 h-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
                  ...
                  <div className="bg-black rounded border border-military-700 relative overflow-hidden flex flex-col h-96 md:h-full min-h-[300px]">
