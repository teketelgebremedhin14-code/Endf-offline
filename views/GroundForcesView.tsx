...
import { Shield, Map, Activity, Users, Settings, Target, Layers, Truck, Zap, Globe, HardHat, Flag, AlertTriangle, CheckCircle, PenTool, TrendingUp, User, ChevronDown, ChevronRight, Edit3, Mic, Radio, StopCircle, BarChart2 } from 'lucide-react';
...
import { analyzeCombatAudio } from '../services/localAiService';
...
const GroundForcesView: React.FC = () => {
    const { t } = useLanguage();
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            <div className="w-full">
                ...
                {/* TAB 5: AI SENTINEL */}
                {activeTab === 'sentinel' && (
                    <div className="h-full flex flex-col items-center justify-center p-6 bg-military-800 rounded-lg border border-military-700 min-h-[400px]">
