...
import { BrainCircuit, Activity, User, Shield, Zap, RefreshCw, FileText, CheckCircle } from 'lucide-react';
...
import { runPsychometricAnalysis } from '../services/localAiService';
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 flex flex-col h-[calc(100vh-140px)]">
            ...
            {!profileData && !analyzing && (
                <div className="flex-1 flex flex-col items-center justify-center bg-military-800 rounded-lg border border-military-700 p-8 max-w-2xl mx-auto">
