...
import { recommendStrategy } from '../services/localAiService';
...
const ChiefOfStaffView: React.FC = () => {
    const { t } = useLanguage();
            ...
            <div className="w-full">
                ...
                {activeTab === 'command' && (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-military-800 rounded-lg p-6 border border-military-700 flex flex-col h-[500px]">
                ...
                {activeTab === 'directives' && (
                    <div className="bg-military-800 rounded-lg p-6 border border-military-700 flex flex-col h-[600px]">
                ...
                {activeTab === 'strategy' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        {/* Result Panel */}
                        <div className="lg:col-span-2 bg-[#0b1120] rounded-lg border border-military-700 p-8 overflow-y-auto relative h-[600px]">
                            {/* Background Pattern */}
