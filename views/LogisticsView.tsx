...
import { generateDynamicData } from '../services/localAiService';
        ...
        <div className="mt-4 md:mt-0 flex flex-wrap gap-2">
            {activeTab === 'supply' && (
                <button 
                    ...
                    className="bg-yellow-600 hover:bg-yellow-700 text-white text-xs font-bold px-4 py-1.5 rounded flex items-center shadow-lg transition-all font-display tracking-wider animate-pulse"
                >
            ...
            {activeTab === 'supply' && (
                <button 
                    ...
                    className="bg-military-accent hover:bg-sky-500 text-white text-xs font-bold px-4 py-1.5 rounded flex items-center shadow-lg transition-all font-display tracking-wider"
                >
