...
import { searchIntelligence, runTerminalCommand } from '../services/localAiService';
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      <div className="w-full">
          ...
          {/* TAB: LINK ANALYSIS */}
          {activeTab === 'link' && (
              <div className="h-[600px] flex flex-col relative overflow-hidden bg-[#050b14] rounded-lg border border-military-700">
          ...
          {/* TAB: OSINT */}
          {activeTab === 'osint' && (
              <div className="flex flex-col p-6 bg-military-800 rounded-lg border border-military-700 min-h-[500px]">
