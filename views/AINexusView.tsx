...
import { BrainCircuit, Activity, Network, TrendingUp, Cpu, Database, Share2, Layers, AlertTriangle, Lightbulb, Hexagon, Globe, BookOpen, ShieldAlert, Crosshair, Users, MapPin, Zap, Scale, FileText, Code, GitBranch, Lock, Microscope, Radio, Server, RefreshCw } from 'lucide-react';
...
import { runAdvancedSimulation } from '../services/localAiService';

const AINexusView: React.FC = () => {
    const { t } = useLanguage();
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 flex flex-col h-[calc(100vh-140px)]">
            ...
            <div className="flex-1 min-h-0 overflow-y-auto relative">
                ...
                {activeTab === 'swarm' && (
                    <div className="h-full grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="bg-military-800 rounded-lg p-6 border border-military-700 flex flex-col relative overflow-hidden">
                            <h3 className="text-lg font-bold text-white mb-4 flex items-center">
                        ...
                        <div className="bg-military-800 rounded-lg p-6 border border-military-700 flex flex-col">
                            ...
                            <div className="flex-1 bg-black/40 rounded p-4 font-mono text-xs overflow-y-auto space-y-3">
                                {swarmLog.map((log, i) => (
                ...
                {/* 14.4 FEDFORCENET */}
                {activeTab === 'federated' && (
                    <div className="h-full bg-military-800 rounded-lg p-6 border border-military-700 flex flex-col items-center justify-center">
                ...
                {activeTab === 'globenet' && (
                    <div className="h-full grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2 bg-black rounded-lg border border-military-700 relative overflow-hidden flex items-center justify-center">
